  ...
  static Future<void> generateAndPrintStatement({
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        // اتجاه المستند بالكامل من اليمين إلى اليسار
        ...
        footer: (pw.Context context) {
          return pw.Column(
            children: [
              ...
              // الوسط   : تم تصميم البرنامج بواسطة علي خلف
              // اليسار  : رقم الصفحة
              // ==================================================
        ...
        build: (pw.Context context) => [
          ...
          pw.TableHelper.fromTextArray(
            ...
            // أحجام الأعمدة
            //
            // ترتيب القائمة يبدأ من الطرف الأيسر في TableHelper.
            //
            // لذلك تم ترتيبها بحيث يكون الناتج المرئي:
            //
            // التاريخ | الحركة | البيان | التحميل | السائق |
            // طن | سعر الطن | مدين | دائن | الرصيد
            //
            ...
            data: events.map((ev) {
              ...
              // ==================================================
              // ترتيب البيانات مطابق تمامًا للـ headers
              // ==================================================
