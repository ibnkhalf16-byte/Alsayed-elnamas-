                    ...
                    GridView.count(
                      ...
                      children: [
                        _buildActionBtn(
                          ...
                          onTap: () {
                             Navigator.push(context, MaterialPageRoute(builder: (_) => const TripsScreen(initialAction: 'purchase')));
                          },
                        ),
                        _buildActionBtn(
                          title: 'نقلة بيع',
                          ...
                          onTap: () {
                             Navigator.push(context, MaterialPageRoute(builder: (_) => const TripsScreen(initialAction: 'sale')));
                          },
                        ),
                        _buildActionBtn(
                          title: 'تحصيل نقدية',
                          ...
                          onTap: () {
                             Navigator.push(context, MaterialPageRoute(builder: (_) => const PaymentsScreen(initialAction: 'from_customer')));
                          },
                        ),
                        _buildActionBtn(
                          title: 'سداد دفعة',
                          ...
                          onTap: () {
                             Navigator.push(context, MaterialPageRoute(builder: (_) => const PaymentsScreen(initialAction: 'to_supplier')));
                          },
                        ),
                        _buildActionBtn(
                          title: 'إضافة طرف',
